...
const handler = async (m, { text, usedPrefix, command, setReply, hanz,sendReact,ucapanWaktu }) => {
...
if (!fs.existsSync(path)) {
        ...
        expiredDate.setDate(now.getDate() + waktuPanel.unli.waktu); 
        const belipanel = {
...
*ᴛᴇʀɪᴍᴀᴋᴀsɪʜ ᴛᴇʟᴀʜ ᴍᴇᴍᴘᴇʀᴄᴀʏᴀɪ ʀᴀɴɢᴇʟᴏғғɪᴄɪᴀʟ*`
    ...
    await hanz.sendMessage(u, { image: { url: "https://raw.githubusercontent.com/Rangelofficial/Uploade-db/main/uploader/1735950753706.jpg" }, caption: ctf });
...
handler.description = ["Unlimited Ram"]
