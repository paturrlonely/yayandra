...
const handler = async (m, { text, setReply,  hanz,ucapanWaktu,sendReact }) => {
...
if (!fs.existsSync(path)) {
        ...
        expiredDate.setDate(now.getDate() + waktuPanel.sevengb.waktu); 
        const belipanel = {
            ...
            data: {
                ...
                loginpanel: domain,
                ram: "7GB",
                harga: waktuPanel.sevengb.harga
            }
        };
