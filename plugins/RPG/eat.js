let handler = async (m, { command, hanz,usedPrefix, args }) => {
  ...
  if (/makan|eat/i.test(command)) {
      ...
      case "kepitingbakar":
        if (user.stamina < 100) {
          if (user.ayamgoreng >= count * 1) {
            ...
            hanz.reply(m.chat, `Nyam nyam`, m);
          } else hanz.reply(m.chat, ` kepiting bakar kamu kurang`, m);
      ...
      case "ayambakar":
        if (user.stamina < 100) {
          if (user.ayambakar >= count * 1) {
            ...
            user.stamina += 20 * count;
            hanz.reply(m.chat, `Nyam nyam`, m);
          } else hanz.reply(m.chat, ` Ayam bakar kamu kurang`, m);
        } else hanz.reply(m.chat, `Stamina kamu sudah penuh`, m);
        break;
      case "pizza":
        if (user.stamina < 100) {
          if (user.pizza >= count * 1) {
            ...
            user.stamina += 20 * count;
            hanz.reply(m.chat, `Nyam nyam`, m);
          } else hanz.reply(m.chat, ` pizza kamu kurang`, m);
        } else hanz.reply(m.chat, `Stamina kamu sudah penuh`, m);
        break;
      case "burger":
        if (user.stamina < 100) {
          if (user.burger >= count * 1) {
            ...
            user.stamina += 20 * count;
            hanz.reply(m.chat, `Nyam nyam`, m);
          } else hanz.reply(m.chat, ` burger kamu kurang`, m);
        } else hanz.reply(m.chat, `Stamina kamu sudah penuh`, m);
        break;
      case "steak":
        if (user.stamina < 100) {
          if (user.steak >= count * 1) {
            ...
            user.stamina += 20 * count;
            hanz.reply(m.chat, `Nyam nyam`, m);
          } else hanz.reply(m.chat, ` Steak kamu kurang`, m);
        } else hanz.reply(m.chat, `Stamina kamu sudah penuh`, m);
        break;
      default:
        await hanz.reply(m.chat, list, m);
    }
    ...
    switch (_type) {
      case "p":
        break;
      default:
        return hanz.reply(m.chat, list, m);
    }
