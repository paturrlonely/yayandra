...
//hanz.fakeReply(m.chat, capt, '0@s.whatsapp.net', 'Inventory', 'status@broadcast')
  //hanz.sendFile(m.chat, 'https://telegra.ph/file/5488aa5c5b3c28cd35e0e.jpg', 'balance.jpg', caption, m)
}

handler.help = ['inventory *@user*']
handler.tags = ['rpg']
handler.command = /^inv1|inventory$/i
