let handler = async (m, { hanz, args, usedPrefix }) => {
        ...
        case 'rubah':
            ...
            if (new Date - global.db.data.users[m.sender].ramuanrubahlast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    hanz.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
                         hanz.reply(m.chat, 'Waktunya Memberi Ramuan Ke Pet *Rubah*', m)
                    }, timebah)
                    if (rubah > 0) {
                        ...
                        if (global.db.data.users[m.sender].anakrubah > naiklvl) {
                            ...
                            hanz.reply(m.chat, `*Selamat Pet Rubah Kamu Naik Level*`, m)
                        }
                    }
        ...
        case 'kuda':
            ...
            if (new Date - global.db.data.users[m.sender].ramuankudalast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    hanz.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
                         hanz.reply(m.chat, 'Waktunya Memberi Ramuan Ke Pet *Kuda*', m)
                    }, timeda)
                    if (kuda > 0) {
                        ...
                        if (global.db.data.users[m.sender].anakkuda > naiklvl) {
                            ...
                            hanz.reply(m.chat, `*Selamat Pet Kuda Kamu Naik Level*`, m)
                        }
                    }
                } else m.reply(`Ramuan Pet Kamu Tidak Cukup`)
        ...
        case 'serigala':
            ...
            if (new Date - global.db.data.users[m.sender].ramuanserigalalast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    hanz.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
                         hanz.reply(m.chat, 'Waktunya Memberi Ramuan Ke Pet *Serigala*', m)
                    }, timela)
                    if (serigala > 0) {
                        ...
                        if (global.db.data.users[m.sender].anakserigala > naiklvl) {
                            ...
                            hanz.reply(m.chat, `*Selamat Pet Serigala Kamu Naik Level*`, m)
                        }
                    }
                } else m.reply(`Ramuan Pet Kamu Tidak Cukup`)
        ...
        case 'naga':
            ...
            if (new Date - global.db.data.users[m.sender].ramuannagalast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    hanz.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
                         hanz.reply(m.chat, 'Waktunya Memberi Ramuan Ke Pet *Naga*', m)
                    }, timega)
                    if (naga > 0) {
                        ...
                        if (global.db.data.users[m.sender].anaknaga > naiklvl) {
                            ...
                            hanz.reply(m.chat, `*Selamat Pet Naga Kamu Naik Level*`, m)
                        }
                    }
                } else m.reply(`Ramuan Pet Kamu Tidak Cukup`)
      ...
      case 'kyubi':
            ...
            if (new Date - global.db.data.users[m.sender].ramuankyubilast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    hanz.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
                         hanz.reply(m.chat, 'Waktunya Memberi Ramuan Ke Pet *Kyuubi*', m)
                    }, timebi)
                    if (kyubi > 0) {
                        ...
                        if (global.db.data.users[m.sender].anakkyubi > naiklvl) {
                            ...
                            hanz.reply(m.chat, `*Selamat Pet Kyuubi Kamu Naik Level*`, m)
                        }
                    }
                } else m.reply(`Ramuan Pet Kamu Tidak Cukup`)
      ...
      case 'centaur':
            ...
            if (new Date - global.db.data.users[m.sender].ramuancentaurlast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    hanz.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
                         hanz.reply(m.chat, 'Waktunya Memberi Ramuan Ke Pet *Centaur*', m)
                    }, timeur)
                    if (centaur > 0) {
                        ...
                        if (global.db.data.users[m.sender].anakcentaur > naiklvl) {
                            ...
                            hanz.reply(m.chat, `*Selamat Pet Centaur Kamu Naik Level*`, m)
                        }
                    }
                } else m.reply(`Ramuan Pet Kamu Tidak Cukup`)
         ...
         case 'phonix':
            ...
            if (new Date - global.db.data.users[m.sender].ramuanphonixlast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    hanz.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
                         hanz.reply(m.chat, 'Waktunya Memberi Ramuan Ke Pet *Phonix*', m)
                    }, timenix)
                    if (phonix > 0) {
        ...
        case 'griffin':
            ...
            if (new Date - global.db.data.users[m.sender].ramuangriffinlast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    hanz.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
                         hanz.reply(m.chat, 'Waktunya Memberi Ramuan Ke Pet *Griffin*', m)
                    }, timefin)
                    if (griffin > 0) {
        ...
        case 'kucing':
            ...
            if (new Date - global.db.data.users[m.sender].ramuankucinglast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    hanz.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
                         hanz.reply(m.chat, 'Waktunya Memberi Ramuan Ke Pet *Kucing*', m)
                    }, timecing)
                    if (kucing > 0) { 
        ...
        case 'hero':
            ...
            if (new Date - global.db.data.users[m.sender].ramuanherolast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                   ...
                   hanz.reply(m.chat, `Berhasil Memberi Ramuan Kepada ${type}`, m)
                    setTimeout(() => {
                         hanz.reply(m.chat, 'Waktunya Memberi Ramuan Ke *Hero*', m)
                    }, timeher)
                    if (hero > 0) { 
                        ...
                        if (global.db.data.users[m.sender].exphero > naiklvl) {
                            ...
                            hanz.reply(m.chat, `*Selamat Hero Kamu Naik Level*`, m)
                        }
                    }
            ...
            break
        default:
            return hanz.reply(m.chat, `*List Ramuan*\n• Hero\n• Kucing\n• Rubah\n• Kuda\n• Naga\n• Centaur\n• Phonix\n• Serigala\n\nContoh: *${usedPrefix}ramuan kucing*`, m)
    }
}
handler.help = ['ramuan']
handler.tags = ['rpg']
