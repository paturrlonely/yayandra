                ...
                switch (_type) {
                    case 'hiu':
                            if (global.db.data.users[m.sender].money >= Bhiu * count) {
                               ...
                               hanz.reply(m.chat, `Sukses Membeli ${count} Hiu Dengan Harga Rp.${Bhiu * count}`, m)
                            } else hanz.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'ikan':
                            if (global.db.data.users[m.sender].money >= Bikan * count) {
                                ...
                                hanz.reply(m.chat, `Sukses Membeli ${count} Ikan Dengan Harga Rp.${Bikan * count}`, m)
                            } else hanz.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'dory':
                            if (global.db.data.users[m.sender].money >= Bdory * count) {
                                ...
                                hanz.reply(m.chat, `Sukses Membeli ${count} Dory Dengan Harga Rp.${Bdory * count}`, m)
                            } else hanz.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'orca':
                            if (global.db.data.users[m.sender].money >= Borca * count) {
                                ...
                                hanz.reply(m.chat, `Sukses Membeli ${count} Orca Dengan Harga Rp.${Borca * count}`, m)
                            } else hanz.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'paus':
                            if (global.db.data.users[m.sender].money >= Bpaus * count) {
                                ...
                                hanz.reply(m.chat, `Sukses Membeli ${count} Paus Dengan Harga Rp.${Bpaus * count}`, m)
                            } else hanz.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'cumi':
                            if (global.db.data.users[m.sender].money >= Bcumi * count) {
                                ...
                                hanz.reply(m.chat, `Sukses Membeli ${count} Cumi Dengan Harga Rp.${Bcumi * count}`, m)
                            } else hanz.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'gurita':
                            if (global.db.data.users[m.sender].money >= Bgurita * count) {
                                ...
                                hanz.reply(m.chat, `Sukses Membeli ${count} Gurita Dengan Harga ${Bgurita * count}`, m)
                            } else hanz.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'buntal':
                            if (global.db.data.users[m.sender].money >= Bbuntal * count) {
                                ...
                                hanz.reply(m.chat, `Sukses Membeli ${count} Buntal Dengan Harga ${Bbuntal * count}`, m)
                            } else hanz.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'udang':
                            if (global.db.data.users[m.sender].money >= Budang * count) {
                                ...
                                hanz.reply(m.chat, `Sukses Membeli ${count} Udang Dengan Harga Rp.${Budang * count}`, m)
                            } else hanz.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'lumba':
                            if (global.db.data.users[m.sender].money >= Blumba * count) {
                                ...
                                hanz.reply(m.chat, `Sukses Membeli ${count} Lumba² Dengan Harga Rp.${Blumba * count}`, m)
                            } else hanz.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'lobster':
                            if (global.db.data.users[m.sender].money >= Blobster * count) {
                                ...
                                hanz.reply(m.chat, `Sukses Membeli ${count} Lobster Dengan Harga Rp.${Blobster * count}`, m)
                            } else hanz.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'kepiting':
                            if (global.db.data.users[m.sender].money >= Bkepiting * count) {
                                ...
                                hanz.reply(m.chat, `Sukses Membeli ${count} Kepiting Dengan Harga Rp.${Bkepiting * count}`, m)
                            } else hanz.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                        
                    break
               default:
                        return hanz.reply(m.chat, Kaine, m)
                }
             break
            case 'jual': 
                switch (_type) {
                    case 'hiu':
                        if (global.db.data.users[m.sender].hiu >= count * 1) {
                            ...
                            hanz.reply(m.chat, `Sukses Menjual ${count} Hiu, Dan Kamu Mendapatkan Rp.${Shiu * count}`, m)
                        } else hanz.reply(m.chat, `Hiu Tiak Cukup`, m)
                        break
                    case 'ikan':
                        if (global.db.data.users[m.sender].ikan >= count * 1) {
                            global.db.data.users[m.sender].ikan -= count * 1
                            global.db.data.users[m.sender].money += Sikan * count
                            hanz.reply(m.chat, `Sukses Menjual ${count} Ikan, Dan Kamu Mendapatkan Rp.${Sikan * count}`, m)
                        } else hanz.reply(m.chat, `Ikan Kamu Tidak Cukup`, m)
                        break
                    case 'dory':
                        if (global.db.data.users[m.sender].dory >= count * 1) {
                            global.db.data.users[m.sender].dory -= count * 1
                            global.db.data.users[m.sender].money += Sdory * count
                            hanz.reply(m.chat, `Sukses Menjual ${count} Dory, Dan Kamu Mendapatkan Rp.${Sdory * count}`, m)
                        } else hanz.reply(m.chat, `Dory Tidak Cukup`, m)
                        break
                    case 'orca':
                        if (global.db.data.users[m.sender].orca >= count * 1) {
                            global.db.data.users[m.sender].orca -= count * 1
                            global.db.data.users[m.sender].money += Sorca * count
                            hanz.reply(m.chat, `Sukses Menjual ${count} Orca, Dan Kamu Mendapatkan Rp.${Sorca * count}`, m)
                        } else hanz.reply(m.chat, `Orca Tiidak Cukup`, m)
                        break
                    case 'paus':
                        if (global.db.data.users[m.sender].paus >= count * 1) {
                            global.db.data.users[m.sender].paus -= count * 1
                            global.db.data.users[m.sender].money += Spaus * count
                            hanz.reply(m.chat, `Sukses Menjual ${count} Paus, Dan Kamu Mendapatkan Rp.${Spaus * count}`, m)
                        } else hanz.reply(m.chat, `Paus Tidak Cukup`, m)
                        break
                    case 'cumi':
                        if (global.db.data.users[m.sender].cumi >= count * 1) {
                            global.db.data.users[m.sender].cumi -= count * 1
                            global.db.data.users[m.sender].money += Scumi * count
                            hanz.reply(m.chat, `Sukses Menjual ${count} Cumi, Dan Kamu Mendapatkan Rp.${Scumi * count}`, m)
                        } else hanz.reply(m.chat, `Cumi Tidak Cukup`, m)
                        break
                    case 'gurita':
                        if (global.db.data.users[m.sender].gurita >= count * 1) {
                            global.db.data.users[m.sender].gurita -= count * 1
                            global.db.data.users[m.sender].money += Sgurita * count
                            hanz.reply(m.chat, `Sukses Menjual ${count} Gurita, Dan Kamu Mendapatkan Rp.${Sgurita * count}`, m)
                        } else hanz.reply(m.chat, `Hiu Tidak Cukup`, m)
                        break
                    case 'buntal':
                        if (global.db.data.users[m.sender].buntal >= count * 1) {
                            global.db.data.users[m.sender].buntal -= count * 1
                            global.db.data.users[m.sender].money += Sbuntal * count
                            hanz.reply(m.chat, `Sukses Menjual ${count} Buntal, Dan Kamu Mendapatkan Rp.${Sbuntal * count}`, m)
                        } else hanz.reply(m.chat, `Buntal Tidak Cukup`, m)
                        break
                    case 'udang':
                        if (global.db.data.users[m.sender].udang >= count * 1) {
                            global.db.data.users[m.sender].udang -= count * 1
                            global.db.data.users[m.sender].money += Sudang * count
                            hanz.reply(m.chat, `Sukses Menjual ${count} Udang, Dan Kamu Mendapatkan Rp.${Sudang * count}`, m)
                        } else hanz.reply(m.chat, `Udang Tidak Cukup`, m)
                        break
                    case 'lumba':
                        if (global.db.data.users[m.sender].lumba >= count * 1) {
                            global.db.data.users[m.sender].lumba -= count * 1
                            global.db.data.users[m.sender].money += Slumba * count
                            hanz.reply(m.chat, `Suksee Menjual ${count} Lumba², Dan Kamu Mendapatkan Rp.${Slumba * count}`, m)
                        } else hanz.reply(m.chat, `Lumba² Tidak Cukup`, m)
                        break
                    case 'lobster':
                        if (global.db.data.users[m.sender].lobster >= count * 1) {
                            global.db.data.users[m.sender].lobster -= count * 1
                            global.db.data.users[m.sender].money += Slobster * count
                            hanz.reply(m.chat, `Suksee Menjual ${count} Lobster, Dan Kamu Mendapatkan Rp.${Slobster * count}`, m)
                        } else hanz.reply(m.chat, `Lobster Tiidak Cukup`, m)
                        break
                    case 'kepiting':
                        if (global.db.data.users[m.sender].kepiting >= count * 1) {
                            global.db.data.users[m.sender].kepiting -= count * 1
                            global.db.data.users[m.sender].money += Skepiting * count
                            hanz.reply(m.chat, `Sukses Menjual ${count} Kepiting, Dan Kamu Mendapatkan Rp.${Skepiting * count}`, m)
                        } else hanz.reply(m.chat, `Kepiting Tidak Cukup`, m)
                        break
               default:
                        return hanz.reply(m.chat, Kaine, m)
                }
