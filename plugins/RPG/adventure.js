...
let handler = async (m, { hanz, usedPrefix }) => {
  try {
    let ct = [
      ...
      "PR", "QA", "RS", "RE", "RO", "RU", "RW", "BL", "SH", "KN",
      "LC", "MF", "PM", "VC", "WS", "SM", "ST", "SA", "SN", "CS",
      "SC", "SL", "SG", "SX", "SK", "SI", "SB", "SO", "ZA", "GS",
      "SS", "ES", "LK", "SD", "SR", "SJ", "SZ", "SE", "CH", "SY",
      "TW", "TJ", "TZ", "TH", "TL", "TG", "TK", "TO", "TT", "TN",
      "TR", "XT", "TM", "TC", "TV", "UG", "UA", "AE", "GB", "US",
      "UM", "UY", "UZ", "VU", "VE", "VN", "VG", "VI", "WF", "EH",
      "YE", "ZM", "ZW",
    ];
    let ke = await fetch(
      `https://api.worldbank.org/v2/country/${ct[Math.floor(Math.random() * ct.length)]}?format=json`
    );
...
⏱️ ${hanz.msToTime(new Date() - user.lastadventure)}`);
