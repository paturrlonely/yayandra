...
setTimeout(() => {
                     hanz.reply(m.chat, hsl, null)
                     }, 27000) 
               
                     setTimeout(() => {
                     hanz.reply(m.chat, rokit4, null)
                      }, 25000)
                
                     setTimeout(() => {
                     hanz.reply(m.chat, rokit3, null)
                     }, 20000) 
                        
                     setTimeout(() => {
                     hanz.reply(m.chat, rokit2, null)
                     }, 15000) 
                    
                     setTimeout(() => {
                     hanz.reply(m.chat, rokit, null)
                     }, 10000) 
                     
                     setTimeout(() => {
                     hanz.reply(m.chat, `🔍 ${name} Mencari Lokasi.....`, null)
                     }, 0) 
  user.lastroket = new Date * 1
    } else hanz.reply(m.chat, `Sepertinya Anda Sudah Kecapekan Silahkan Istirahat Dulu sekitar\n🕔 *${timers}*`, m)
}
handler.help = ['roket']
handler.tags = ['rpg']
