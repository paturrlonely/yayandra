...
let handler = async(m, { hanz, args, usedPrefix, command, text }) => {
...
`.trim()
                                     setTimeout(() => {
                                          hanz.reply(m.chat, 'Yuk meracik lagi..', m)
                                      }, timeoutu)
                                     setTimeout(() => {
                                          hanz.reply(m.chat, srcs, m)
                                      }, timeoutem)
                                     setTimeout(() => {
                                          hanz.reply(m.chat, 'Mohon tunggu sedang mengaduk ramuan', m)
                                      }, timeoute)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          hanz.reply(m.chat, srcn, m)
                                      }, timeouten)
                                     setTimeout(() => {
                                          hanz.reply(m.chat, 'Mohon tunggu sedang mengaduk potion', m)
                                      }, timeouto)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          hanz.reply(m.chat, srcng, m)
                                      }, timeoutel)
                                     setTimeout(() => {
                                          hanz.reply(m.chat, 'Mohon tunggu sedang mengaduk string', m)
                                      }, timeoutol)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          hanz.reply(m.chat, srcngs, m)
                                      }, timeouteg)
                                     setTimeout(() => {
                                          hanz.reply(m.chat, 'Mohon tunggu sedang mengaduk sword', m)
                                      }, timeoutog)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          hanz.reply(m.chat, srcngsw, m)
                                      }, timeoutwww)
                                     setTimeout(() => {
                                          hanz.reply(m.chat, 'Mohon tunggu sedang mengaduk weapon', m)
                                      }, timeoutww)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          hanz.reply(m.chat, srcngsk, m)
                                      }, timeoutey)
                                     setTimeout(() => {
                                          hanz.reply(m.chat, 'Mohon tunggu sedang mengaduk iron', m)
                                      }, timeoutoy)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          hanz.reply(m.chat, 'Mohon tunggu sedang mengaduk pancingan', m)
                                      }, timeoutoy)
                                      if (pancingan > 0) {
                                      ...
                                      hanz.reply(m.chat, `*Selamat pancingan kamu naik level*`, m)
                                      }
                                    }
                     ...
                     break
                           default:
                                  return hanz.reply(m.chat, `${usedPrefix + command} [ramuan | potion | string | iron | sword | weapon | pancingan]\nContoh penggunaan: *${usedPrefix + command} ramuan*`, m)
                           }
                        }
