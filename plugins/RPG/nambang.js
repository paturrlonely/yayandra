...
hanz, usedPrefix
    ...
    let penambang = await hanz.getName(m.sender)
...
setTimeout(() => {
                     ...
                     setTimeout(() => {
                     hanz.reply(m.chat, jln3, m)
                     }, 20000) 
                        
                     setTimeout(() => {
                     hanz.reply(m.chat, jln2, m)
                     }, 15000) 
                    
                     setTimeout(() => {
                     hanz.reply(m.chat, jln, m)
                     }, 10000) 
                     
                     setTimeout(() => {
                     hanz.reply(m.chat, `${penambang} Mencari Area Nambang.....`, m)
                     }, 0) 
