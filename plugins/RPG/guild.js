let handler = async (m, { hanz, command, args }) => {
    ...
    if (!user.guild) return hanz.reply(m.chat, 'Kamu belum tergabung dalam guild. Gunakan .joinguild <nama_guild> untuk bergabung ke guild atau buat guild baru dengan .createguild <nama_guild>.', m);
