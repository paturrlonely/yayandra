...
let handler = async (m, { hanz, args, usedPrefix }) => {
    ...
    if (A > K) {
      ...
      hanz.sendFile(m.chat, 'https://telegra.ph/file/60437ce6d807b605adf5e.jpg', 'zonk.jpg', `*Airdrop Ampas!* Ternyata isinya tidak sesuai ekspektasi\n\n*Rewards*\n• *Sampah:* ${sampah}\n• *Kayu:* ${kayu}\n• *Batu:* ${batu}`, m);
      ...
      hanz.sendFile(m.chat, 'https://telegra.ph/file/d3bc1d7a97c62d3baaf73.jpg', 'rare.jpg', `*Airdrop Rare!*, Kamu mendapatkan Kotak Airdrop *Rare*\n\nSelamat kamu mendapatkan *Rewards*\n• *Limit:* ${limit}\n• *Money:* ${money}\n• *Point:* ${point}`, m);
      u.limit += parseInt(limit);
      u.money += parseInt(money);
      u.poin += parseInt(point);
      u.lastclaim = new Date * 1;
    } else {
      hanz.sendFile(m.chat, 'https://telegra.ph/file/5d71027ecbcf771b299fb.jpg', 'zonk.jpg', `*Airdrop Zonks!*, Kamu mendapatkan Kotak Airdrop *Zonk (Kosong)*\n\nSelamat kamu mendapatkan *Rewards*\n• *Money:* -1.000.000\n• *Isi:* Angin`, m);
      u.money -= 1000000;
      u.lastclaim = new Date * 1;
    }

    /*setTimeout(() => {
      hanz.reply(m.chat, `Waktunya berburu *Airdrop!*`, m);
    }, timeout);*/
};
